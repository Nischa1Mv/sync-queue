...
export type SyncHandler<TPayload> = (context: SyncHandlerContext<TPayload>) => Promise<SyncOutcome>;
...
export type PayloadValidator<TPayload> = (payload: unknown) => ValidatorResult | Promise<ValidatorResult>;
